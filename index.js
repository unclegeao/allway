...
const SUB_PATH = process.env.SUB_PATH || 'link';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '80aef50e-63c0-4df2-925d-1cb3f348fe0f'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const NAME = process.env.NAME || 'AllWAY';                  // 节点名称
